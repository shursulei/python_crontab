...
def parse_crontab_time(conf_string):
    ...
    days=juest_days_by_month(year, month)
    time_limit = ((0, 59), (0, 23), days, (1, 12), (0, 6))
    crontab_range = []
    clist = []
    conf_length = 5
...
def juest_days_by_month(year,month):
        days = ()
...
if __name__ == '__main__':
    ...
    # year=time.localtime(time.time()).tm_year
    # month=time.localtime(time.time()).tm_mon
    #print  juest_days_by_month(year,month)
    main()
    # print get_struct_time(1574237887)